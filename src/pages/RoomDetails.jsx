    ...
    return room && (
        <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <div className='flex flex-wrap items-center mt-3 mb-6 gap-4'>
                            {room.amenities.map((item, index)=>(
                                <div key={index} className='flex items-ccenter gap-2 px-3 py-2 rounded-lg bg-gray-100'>
            ...
            <div className='max-w-3xl border-y border-gray-300 my-15 py-10 text-gray-500'>
                <p>Guests will be allocated on the ground floor according to avability. You get a comfortable Two bedroom apartment has a true city feelings. 
                   ...
                   group floor according to avability.</p>
            </div>
